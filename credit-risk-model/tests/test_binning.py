...
def get_binning_objects():
    actual_response_binning = BinningProcess.load("data/reference/auto-binning-process.pkl")
    expected_response_binning = BinningProcess.load("data/uat/preprocessing/binning-transformer.pkl")
    return actual_response_binning, expected_response_binning
# @pytest.fixture
def test_compare_tables(get_binning_objects):#(actual_response, expected_response, significant_digits=2):
